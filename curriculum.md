...
- **STEP 34:** [Lights](lessons/37-lights.html) — UsdLuxのLight型とLightAPIで光を記述する

## [7. 時間を記述する](chapters/07-time.html)

値が時間で変わる書き方です。Compositionへ進む前に済ませておきます。

- **STEP 35:** [Time CodeとTime Sample](lessons/11-time-codes-samples.html) — 時点と値で時間変化を記述する

## [8. Prim Specの3つの書き方](chapters/08-specifiers.html)

Compositionの前に、def・over・classの違いをここで確実にします。これがないと合成の説明が読めません。

- **STEP 36:** [def](lessons/27a-def.html) — Primを定義する
- **STEP 37:** [over](lessons/27b-over.html) — 既存PrimへOpinionだけを重ねる
- **STEP 38:** [class](lessons/27c-class.html) — Inherits用の抽象Prim Specを作る

## [9. コンポジション](chapters/09-composition.html)

OpenUSDでいちばん難しい部分です。ここまでの土台があって初めて読み進められます。

- **STEP 39:** [コンポジションとLIVERPS](lessons/12-composition.html) — 強度順序、SublayerとLocalの関係、Opinionの上書き
- **STEP 40:** [SublayerとLayer Stack](lessons/12-sublayers.html) — 同じnamespaceを積み、Local内の強弱を追う
- **STEP 41:** [L · Local Opinion](lessons/12-local.html) — 利用側の直接Opinionで上書きする
- **STEP 42:** [I · Inherits](lessons/12-inherits.html) — クラスの変更をbroadcastする
- **STEP 43:** [V · Variant Sets](lessons/12-variants.html) — 名前付き選択肢を合成する
- **STEP 44:** [E · rElocates](lessons/12-relocates.html) — namespace上のPathを移し替える
- **STEP 45:** [R · References](lessons/12-references.html) — 階層の接ぎ木とPath変換を追う
- **STEP 46:** [P · Payloads](lessons/12-payloads.html) — Load可能な内容を合成する
- **STEP 47:** [S · Specializes](lessons/12-specializes.html) — 最も弱いfallbackを共有する
- **STEP 48:** [Value Resolution](lessons/21-value-resolution.html) — Composition後のPropertyから最終値を選ぶ
...
- **STEP 49:** [Default Prim](lessons/09a-default-prim.html) — Layerを外から利用するときの入口を決める
- **STEP 50:** [metersPerUnit](lessons/20a-meters-per-unit.html) — 長さの「1」が何メートルかを宣言する
- **STEP 51:** [upAxis](lessons/20b-up-axis.html) — どの軸が上かを宣言する
- **STEP 52:** [kilogramsPerUnit](lessons/20c-kilograms-per-unit.html) — 質量の「1」が何キログラムかを宣言する

## [11. Compositionを組み立てる](chapters/11-composition-practice.html)

合成の仕組みが分かったところで、実際の組み立て方と、原因を追う道具へ進みます。

- **STEP 53:** [Prim Composition](lessons/28-prim-composition.html) — 複数のPrim Specが一つになる
- **STEP 54:** [Internal ArcとExternal Arc](lessons/29-internal-external-arc.html) — 同じLayer内と別ファイル
- **STEP 55:** [List Editing](lessons/30-list-editing.html) — prepend・append・delete・reorder
- **STEP 56:** [Encapsulation](lessons/31-encapsulation.html) — Assetの境界を守る
- **STEP 57:** [Variant Edit Context](lessons/32-variant-edit-context.html) — 選択肢の中へ書く
